...
<title>Google Appsとの連携でデータの可視化｜SmartGarageシリーズ｜有限会社長靴倶楽部</title>
				...
				<div class="col-sm-12 col-xs-12">
						<div id="sg"> 
								...
								<div class="topContent">
										<div class="container mainBox"> 
												...
												<div class="row">
														...
														<div class="col-sm-6 col-xs-12 iconBox"> <img class="icon" src="images/smartgarage/sgs-img01.png" width="80%" alt="Google Appsとの連携でデータの可視化を実現"> </div>
												</div>
												<div class="row">
								...
								<div class="hidden-xs">
										...
										<img class="mgB-50" src="images/smartgarage/sgs-img02.png" width="100%" alt="Google Appsとの連携でデータの可視化を実現"> </div>
								<!--スマホ表示-->
								<div class="visible-xs"> <img class="mgB-50" src="images/smartgarage/sgs-img02s.png" width="100%" alt=""> </div>
								<div class="container mainBox" id="smartgarage"> 
										...
										<div class="col-sm-12 col-xs-12 sg_box" id="sgMap">
												<div class="col-sm-3 col-xs-12 center mgB-20">
														<div class="col-sm-12 col-xs-5"><img src="images/smartgarage/sgmap.png" width="70%" alt="Google Maps を活用して地図上で情報を見える化"></div>
										...
										<div class="col-sm-12 col-xs-12 sg_box" id="sgData">
												<div class="col-sm-3 col-md-push-9 center mgB-20">
														<div class="col-sm-12 col-xs-5"><img src="images/smartgarage/sgData.png" width="90%" alt="大量のデータと写真をすぐにその場で登録"></div>
														<div class="col-sm-12 col-xs-7">
																<h3>SmartGarage<br>
																		<span>Data</span></h3>
										...
										<div class="col-sm-12 col-xs-12 sg_box" id="sgMieruka">
												<div class="col-sm-3 col-xs-12 center mgB-20">
														<div class="col-sm-12 col-xs-5"><img src="images/smartgarage/sgMieru.png" width="100%" alt="進捗率や販売率などの比較を見える化"></div>
														<div class="col-sm-12 col-xs-7">
																<h3>SmartGarage<br>
																		<span>Mieruka</span></h3>
																<input type="button" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" value="準備中" style="background-color:#ddd">
														</div>
												</div>
												<div class="col-sm-9 col-xs-12 pa-15">
										...
										<div class="col-sm-12 col-xs-12 sg_box" id="sgIgnite">
												<div class="col-sm-3 col-md-push-9 center mgB-20">
														<div class="col-sm-12 col-xs-5"><img src="images/smartgarage/sgIgn.png" width="90%" alt="現在地と移動経路を一元管理で効率化"> </div>
														<div class="col-sm-12 col-xs-7">
																<h3>SmartGarage<br>
																		<span>IGNITE</span></h3>
																<input type="button" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" value="準備中" style="background-color:#ddd">
										...
										<div class="col-sm-12 col-xs-12 sg_box" id="sgLocator">
												<div class="col-sm-3 col-xs-12 center mgB-20">
														<div class="col-sm-12 col-xs-5"><img src="images/smartgarage/sgLoca.png" width="90%" alt="ユーザーの必要な情報をMAP上に表示"></div>
														<div class="col-sm-12 col-xs-7">
																<h3>SmartGarage<br>
