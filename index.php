...
<div id="allContent"> 
		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
				...
				<div class="container mainBox">
						<div class="row">
								<div class="col-md-12">
										<h2 class="mgBoth h2_title">SmartGarageとは？</h2>
								...
								<div class="col col-sm-9">
										<div class="row info_p">
												<div class="infomation"> 
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p>制作及びシステム開発の料金改定を行いました。<br>
																		詳しくは販売促進部までお問い合わせ下さい。</p>
														</div>
														<!--記事4-->
														<div class="col col-md-2 col-sm-2 col-xs-4">
																<p>2015/04/03</p>
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p><!--a href="sgs.html"-->SmartGarageシリーズのプレスリリースを発表しました。<!--/a--></p>
														</div>
														<!--記事2-->
														<div class="col col-md-2 col-sm-2 col-xs-4">
																<p>2015/04/01</p>
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p>SmartGarageシリーズのページを追加しました。</p>
																<p>SmartGarage Mail：ユーザの登録とメールの配信をすばやく手軽に。<br>
																		SmartGarage Map：誰もが使えるGIS。地図からの情報登録をかんたんに。<br>
																		SmartGarage Data：タブレットを使った現場での情報登録で効率化を実現。 </p>
														</div>
														<!--記事2-->
														<div class="col col-md-2 col-sm-2 col-xs-4">
																<p>2015/01/29</p>
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p>年末年始営業のお知らせ<br>
																		＝年末年始の休業期間＝<br>
																		2014年12月27日～2015年1月4日<br>
																		2015年1月5日より通常業務いたします。 </p>
														</div>
														<!--記事1-->
														<div class="col col-md-2 col-sm-2 col-xs-4">
																<p>2014/12/18</p>
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p> <a href="isms.php">情報セキュリティ・マネジメントシステムの国際規格であるISO/IEC 27001:2013（JIS Q 27001:2014）の認証を取得しました。</a></p>
														</div>
														<!--記事2-->
														<div class="col col-md-2 col-sm-2 col-xs-4">
																<p>2014/07/03</p>
														...
														<div class="col col-md-10  col-sm-10 col-xs-8">
																<p><!--a href="pms.html"-->写真管理システム『PMS-01』のプレスリリースを発表しました。<!--/a--></p>
														</div>
												</div>
												<!--information--> 
										</div>
...
<script src="js/jquery.liquid-slider.min.js" type="text/javascript"></script> 
