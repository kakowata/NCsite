		...
		<div class="row grey ">
				<div class="col-sm-12 col-xs-12">
						<div id="contact"> 
								...
								<!--PC表示-->
								<div class="hidden-xs">
										<div class="bottom-tease"> <a href="#page2">
												<button class="pagedown">Scroll</button>
												</a> </div>
										<img class="bottom" src="../../images/contact/con-img03.png" width="100%" alt="company"> </div>
								<!--スマホ表示-->
										...
										<div id="page2">
												...
												<form id="form1" name="form1" method="post" action="<?= $_SERVER['SCRIPT_NAME'] ?>">
														...
														<div class="mdl-card__title">
																<p class="mdl-card__title-text">お問い合わせ（内容確認）</p>
														</div>
