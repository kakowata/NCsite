...
<title>システム構築のお見積もり・ご相談承ります！｜お問い合わせ｜有限会社長靴倶楽部</title>
				...
				<div class="col-sm-12 col-xs-12">
						<div id="contact"> 
								...
								<div class="topContent">
										<div class="container mainBox"> 
												...
												<div class="row">
														...
														<div class="col-sm-6 col-xs-12 iconBox"> <img class="icon" src="../../images/contact/con-img01-1.png" width="300px" alt="採用情報"> </div>
												</div>
												<div class="row">
								...
								<div class="hidden-xs">
										...
										<img class="mgB-50" src="../../images/contact/con-img03.png" width="100%" alt="company"> </div>
								<div class="container mainBox">
										<div id="page2">
												...
												<form id="form1" name="form1" method="post" action="<?php echo $_SERVER['SCRIPT_NAME'] ?>">
														...
														<div class="mdl-card__actions mdl-card--border">
																<div id="form_box">
																		...
																		<div class="col-sm-12 col-xs-12">
																				<div class="col-sm-2 col-xs-12 th">所属名</div>
																		...
																		<div class="col-sm-12 col-xs-12">
																				...
																				<div class="col-sm-10 col-xs-12 td">
																						<div class="mdl-textfield mdl-js-textfield">
																								<input class="mdl-textfield__input" name="email2" type="url" id="textfield8" maxlength="250" value="<?php echo $frm['email2']['value']; ?>" />
																		...
																		<div class="col-xs-12">
																				...
																				<div class="col-sm-10 col-xs-12 td">
																						<div class="mdl-textfield mdl-js-textfield">
																								<textarea class="mdl-textfield__input" name="comment" type="text" rows= "3" id="textarea"><?php echo $frm['comment']['value']; ?></textarea>
