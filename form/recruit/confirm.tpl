		...
		<div class="row grey ">
				<div class="col-sm-12 col-xs-12">
						<div id="contact"> 
								...
								<!-- topContent ここまで　--> 
								<!--PC表示-->
								<div class="visible-xs"> <img class="icon" src="../../images/contact/con-img03s.png" width="100%" alt="採用情報"> </div>
								<div class="hidden-xs">
														...
														<div class="mdl-card__actions mdl-card--border">
																<div id="form_box">
																		...
																		<div class="col-sm-6 col-xs-12">
																				...
																				<div class="col-sm-8 col-xs-12 td">
																						<div class="mdl-textfield mdl-js-textfield"><?= $frm['postal']['value'] ?><span style="color:#FFFFFF">郵便番号</span>
																						</div>
																				</div>
																		</div>
																		<div class="col-sm-6 col-xs-12">
