...
<option value="Webディレクター（正社員）">ディレクター（正社員）</option>-->
																										...
																										<div class="col-sm-6 col-xs-12">
																												...
																												<div class="col-sm-8 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																<input class="mdl-textfield__input" type="tel" name="telephone" id="textfield3" maxlength="30" value="<?php echo $frm['telephone']['value']; ?>" />
																																<label class="mdl-textfield__label" for="textfield3">09012345678</label>
																														</div>
																												</div>
																										</div>
																										<div class="col-sm-6 col-xs-12">
																												...
																												<div class="col-sm-8 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																<input class="mdl-textfield__input" type="email" name="email2" id="textfield4" maxlength="250" value="<?php echo $frm['email2']['value']; ?>" />
																																<label class="mdl-textfield__label" for="textfield4">taro***@signite.ne.jp</label>
																														</div>
																												</div>
																										</div>
																										<div class="col-sm-6 col-xs-12">
																												...
																												<div class="col-sm-8 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																<input class="mdl-textfield__input" type="tel" name="postal" id="textfield5" maxlength="10" value="<?php echo $frm['postal']['value']; ?>" />
																										...
																										<div class="col-sm-6 col-xs-12">
																												...
																												<div class="col-sm-8 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																<input class="mdl-textfield__input" type="tel" name="birth" id="textfield6" maxlength="250" value="<?php echo $frm['birth']['value']; ?>" />
																																<label class="mdl-textfield__label" for="textfield6">19900101</label>
																														</div>
																												</div>
																										</div>
																										<div class="col-xs-12">
																												...
																												<div class="col-sm-10 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																...
																																<label class="mdl-textfield__label" for="textfield7">東京都府中市宮町2-15-13 第15三ツ木ビル6F</label>
																														</div>
																												</div>
																										</div>
																										<div class="col-xs-12">
																												...
																												<div class="col-sm-10 col-xs-12 td">
																														<div class="mdl-textfield mdl-js-textfield">
																																<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="textfield8">
																																		<input type="radio" name="sex" value="男性" id="textfield8" style="border:none;" class="mdl-radio__button" checked />
																																		<span class="mdl-radio__label">男性</span> </label>
																																<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="textfield9">
																																		<input type="radio" name="sex" value="女性" id="textfield9" style="border:none;" class="mdl-radio__button" />
