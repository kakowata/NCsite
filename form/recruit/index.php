...
$fields = array(
  ...
  '性別'                    => array('name'      => 'sex',
                                    ...
                                    'multiline' => FALSE,
                                    'value'     => ''),
 '生年月日'                 => array('name'      => 'birth',
                                    'initial'   => '',
                                    'required'  => TRUE,
                                    'match'     => '/\A.{1,255}\z/msux',
                                    'multiline' => FALSE,
                                    'value'     => ''),
  '郵便番号'                => array('name'      => 'postal',
                                    'initial'   => '',
                                    'required'  => FALSE,
                                    'match'     => '/\A.{1,255}\z/msux',
                                    'multiline' => FALSE,
  ...
  '自己PR'                  => array('name'      => 'comment',
                                    'initial'   => '',
                                    'required'  => TRUE,
                                    'match'     => '/\A.{1,2000}\z/msux',
                                    'multiline' => FALSE,
                                    'value'     => ''),
  '質問、確認事項等'        => array('name'      => 'question',
                                    'initial'   => '',
                                    'required'  => FALSE,
                                    'match'     => '/\A.{1,2000}\z/msux',
                                    'multiline' => TRUE,
    ...
    if ($value == $field['initial'] || $value == '') {
	  ...
	  if (isset($frm_separated[$key]) )
	  {
			if (! isset($frm_separated_err[ $frm_separated[$key] ]) )
			{
				...
				$error_data[] = $frm_separated[$key] . 'を入力して下さい。';
			}
	  }
	  else
	  {
		  $error_data[] = $key . 'を入力して下さい。';
	  }
      continue;
    }
  }
...
{
/*	if (! (mb_ereg("^[0-9-]+$",$frm['telephone']['value']) )  )
	{
		$error_data[] = '電話番号は半角数値とハイフンのみでご入力下さい。';
	}
*/
